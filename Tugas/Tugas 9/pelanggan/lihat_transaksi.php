       ...
       <table class="table table-striped">
           ...
           <tbody>
               ...
               <tr>
                   ...
                   <td><?= isset($row['Nama_Pelanggan']) ? htmlspecialchars($row['Nama_Pelanggan']) : '' ?></td>

                   <td><?= $row['Tanggal_Pesanan'] ?></td>
                   <td>Rp<?= number_format($row['Total_Harga'], 2) ?></td>
                   <td>
                        <a href="hapus_pelanggan.php?id=<?= $row['Pesanan_ID'] ?>"
                        class="btn btn-danger btn-sm"
                        onclick="return confirm('Yakin ingin hapus pelanggan ini? Semua pesanan akan ikut terhapus!')">Hapus</a>
                  </td>
               </tr>
               <?php endwhile; ?>
           </tbody>
