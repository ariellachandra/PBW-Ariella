<?php 
       ...
       if (!isset($_SESSION['login_Un51k4'])) {
            header("Location: login.php?message=" . urlencode("Login dulu broooo :D"));
           exit;
       }
       ...
       <table class="table table-striped">
           ...
           <tbody>
               ...
               <tr>
                   ...
                   <td>
                       <a href="/Tugas/Tugas 10/buku/form_edit.php?id=<?php echo $row['ID'] ?>" class="btn btn-sm btn-warning">Edit</a>
                       <a href="/Tugas/Tugas 10/buku/proses_hapus.php?id=<?php echo $row['ID'] ?>" class="btn btn-sm btn-danger" onclick="return confirm('Yakin ingin menghapus?')">Hapus</a>
                   </td>
               </tr>
               <?php endwhile; ?>
           </tbody>
